 ...
 * \brief Prolongation
 *
 * @param[in] v_2h    vector with values on the rougher grid
 * @param[in] v_h     vector for the values on the finer grid
 * @param[in] N       gridsize of the rougher grid
 *
 * @param[out] v_2h   new finer grid with prolongated values
 *
 * \author Robin Sell
 * \author Neil Vetter
 *
