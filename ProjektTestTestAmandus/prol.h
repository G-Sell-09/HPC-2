 ...
 * \brief Prolongation
 *
 * @param[in] v_2h    vector with values of the rougher grid
 * @param[in] v_h     vector for the values of the finer grid
 * @param[in] N       size of the rougher grid
 *
 * @param[out] v_2h   values of the new finer grid
 *
 * \author Robin Sell
 * \author Neil Vetter
 *
